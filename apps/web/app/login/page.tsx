...
function LoginForm() {
  ...
  // Surfaces a failure from the /auth/callback redirect (e.g. the magic
  // link's code exchange failing) — previously this silently landed back
  // on a blank login form with zero explanation.
  useEffect(() => {

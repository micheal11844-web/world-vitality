 ...
 * with a disclosure chevron; Renewable Energy's own sub-pages nest
      ...
      sidebarSections={[
        {
          key: "workspaces",
          label: "Workspaces",
          items: buildWorkspaceSidebarItems("renewable-energy", activeKey),
        },
      ]}
      sidebarDefaultExpandedKeys={["renewable-energy"]}
